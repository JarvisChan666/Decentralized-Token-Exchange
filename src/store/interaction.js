...
export const loadNetworks = async (provider, dispatch) => {
...
// integrate this four functions in one function
...
//     const token = await loadToken(provider, TOKEN_ABI, dispatch)

//     return { provider, chainId, account, token }
// }
